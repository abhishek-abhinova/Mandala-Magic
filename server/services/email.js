...
module.exports = {
  ...
  adminNewOrder(order) { return send({ to: 'support@mandalamagic.shop', subject: 'New order ' + order.order_number, title: 'New Order 🎉', body: '<p>A new order has been placed: <strong>' + order.order_number + '</strong> — $' + order.total.toFixed(2) + '</p>' }); },
};